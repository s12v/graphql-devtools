'use strict';
// Packs the extension into dist/graphql-devtools-<version>.zip: only the files the
// browser needs, nothing from test/, demo/, .github/ or the npm metadata.
...
const out = path.join(dist, `graphql-devtools-${manifest.version}.zip`);
