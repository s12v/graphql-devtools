...
var har = {
  ...
  operation : function (raw, index, batch) {
    ...
    var operationName = typeof raw.operationName == "string" && raw.operationName ? raw.operationName
      : typeof raw.fb_api_req_friendly_name == "string" && raw.fb_api_req_friendly_name ? raw.fb_api_req_friendly_name : null;
